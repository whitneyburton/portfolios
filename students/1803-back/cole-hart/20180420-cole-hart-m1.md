...
* **B: Individual Work & Projects**: 2.5 _No Date Night/Credit Check submission, but did Mastermind_
...
##### Description
Built a system to manage data and execute business intelligence queries against the data from a typical e-commerce business.
