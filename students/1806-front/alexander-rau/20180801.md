...
Feedback to me - I do not necessarily remember feedback specific to me, but, overall, Alex and I worked really well in our partnership and were able to successfully exceed past the goals we had set for ourselves.
...
- nice job breaking-out global variable, event listeners and function declarations
...
- nice work using an array for the quality values, but experiement storing the index of a quality from the array in the constructor function, as opposed to storing each quality index position as its own variable
...
Feedback to me - Again, I do not remember receiving feedback specific to me, but, overall, Justin and I worked really well togehter, as well, and I was particularly proud of our finished product (especialy opur successful usage of more complicated JS things like the constructor function and array manipulation).
...
Feedback to me - As with the others, I do not rememeber specific feedback just to me, but, as a parntership, Cole and I worked extremely well together.  This was the first of the projects I was able to fully complete, and I learned a lot from having a more advanced partner like Cole.
...
In this session, we learned about the different types of stress, and healthy ways to deal and cope with them.  Each different type of stress commands different coping methods, and, from how I understand it, the most important thing is to be aware of how you are feeling any why.  This was eary on in the Mod, and our classwork had not realy ramped-up, yet, so I was not sure what to expect.  However, this discussion on stress early on helped me out in being ready for what was to come.  I also remember them talking about building your own self-care kit, and one of my fellow Cohort-mates sharing hers.  It was enlightening and informative.  For me, particularly, I have used music as an effective coping mechanism for stress during the Mod, and always make sure to have headphones with me.
