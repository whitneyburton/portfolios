...
Score: 3 Notes: Confusion on what and how to access methods on a class from the controller but was able to implement solutions at the controller level. Struggled moving it to the model.
