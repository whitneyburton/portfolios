...
* What are three technical concepts you learned during this project?
 ...
 - Promises / Callback Functions - Mostly I would run into issues with asynchronous Javascript and needed to find a way to pass along a promise to ensure that something specific was executed around an AJAX call or a database query was executed.
 - CORS, which stands for "Cross-Origin Resource Sharing" allows web applications to overcome some security restrictions imposed by browsers for requests from different domains. For the sake of our project, it allowed us to make requests to our backend from our frontend browser since our domains are completely different between our back-end and front-end platforms.
 - Javascript Debugging techniques - I am typically a 'pry' queen, but I also learned how to make console.log() and debugger super effective in the front end!
...
First someone  asked me if I could take notes, so I said no. Then no one had any direction and we were spiraling into chaos, so again I had to be this stern voice of reason, pull us into study room to finalize the video content for the Gear Up and finalize our pull request... that was irritating, but I suppose it was a good experience for me given that I will continue to have to work in a male-dominated space.

The rewarding parts were that I really enjoyed the content, and have been consciously thinking about how I've been subjected to extreme distractions via persuasive technology techniques from applications like Facebook, Instagram, etc.

** Add something here about how the actual gear up went. **
