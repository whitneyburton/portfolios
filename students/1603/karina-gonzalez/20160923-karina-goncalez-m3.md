...
#### VolunteerCope (Self-Directed Project)
...
Apicurious consumes the Github API and recreates the user's Github profile page through API calls.  I decided to hand-roll my own oauth.
