...
IdeaBox was the first project of Module Four. It was a one page application that contained an in-house API. The goal was to manipulate ideas using strictly AJAX and jQuery.     
