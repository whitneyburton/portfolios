...
Evaluation comments: well done! JS was very verbose in areas (specifically around appending the cards to the DOM).  Refactoring would drastically reduce the number of lines of code and increase clarity/legibility. Well crafted CSS and HTML
...
Partner Feedback: “You were a great partner - I felt like we communicated well with each other and you were great at keeping in touch even though we couldn’t always physically work in the same place. You know what you are doing and are great at looking up what you don’t know. In the future, I’d suggest what I’d suggest for myself - even when the project is working to keep pushing to make better code that is more succinct and easier to read.”
...
IdeaBox's purpose was to build an app that stored a bunch of ideas which could then be upvoted/downvoted, amended, deleted or searched. This introduced the concept of localstorage and data manipulaton via the DOM as well as sorting and filtering. 

Evaluation Comments: Make sure you're watching indentation! Mind the little details. Well crafted code, could use a refactor pass (which is a good place to be).  Both have solid ownership of entire codebase. Make sure you're being mindful accessibility best practices.
...
Feedback to Me:
"Dear Thomas, I really enjoyed working with you on our LinkedList project.  I liked how we were able to accomplish a lot working independently, but then come together to make sure that everything was integrated and work on the trickier problems.  Your problem-solving skills and logical way of thinking were a big asset to our project. It was also inspiring for me to see you trying new things not only with the code for our project but with your development tools. Not only are the new colors in your command line super awesome, but I think that if you continue to look into tools for development like that, it will continue to increase your coding efficiency in the future. The biggest thing you could work on is the organization of your CSS. Although the CSS that you worked on for our project presented the content great, there were a couple of times when you repeated properties or selectors (like having two places where 'h2' is selected). If you come up with a certain way that you always write CSS, I think it could make it cleaner and easier to read, like your JavaScript already is. Thanks, Katie"
...
2doBox's goal was to take a code base from somebody else's Ideabox and expand upon the functionality and add features while also refactoring the code. 

Evaluation Comments:
Lot of redundancy and duplication in CSS. Sloppy CSS. Obvious that JS took a priority and was what they were most interested in it. Lots of interesting approaches and solutions in JS. UI redesign is not effective. Needs a lot of work and tidying.
