...
* [GitHub URL](https://github.com/julieahawkins/ideabox-r-j)
* [Original Assignment](http://frontend.turing.io/projects/ideabox.html)

This project was to create an app that allows the user to create a list of ideas. The app user local storage to store the users ideas. The user is able to edit previously created ideas and there is a search functionality. The ideas can be upgraded or downgraded based on quality. The user can delete unwanted ideas. 
