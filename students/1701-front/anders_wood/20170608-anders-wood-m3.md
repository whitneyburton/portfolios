...
This was our first Redux project. We used redux and routers as well as a pre-packaged backend to display movie information using an API that pulls from The Movie DB site.
