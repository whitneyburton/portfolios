...
* Unclear on what return is needed for, especially when completing the organize prototype in mermaid - needed major hints to return the sorted array instead of undefined...
